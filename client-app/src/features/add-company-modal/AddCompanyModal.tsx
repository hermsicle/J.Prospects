...
import { createCompany, updateCompany } from '@/services/apis';
import {
  Button,
  Dialog,
  Field,
...
const AddCompanyModal = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      prospectCount: 0, // formData.prospects.length === 1 ? 1 : 0,
    };
  ...
  const handleEditSubmit = (e: React.FormEvent) => {
    ...
    const payload = {
      companyName: formData.companyName,
      companyDescription: formData.companyDescription,
      prospectCount: selectedCompany.prospectCount, // keep existing count
    };
              ...
              <Flex gap={2}>
                <Stack w={generatedCoverLetter ? '60%' : '100%'} gap="4">
                  ...
                  <Button
                    ...
                    colorScheme="blue"
                    disabled={
                      !formData.companyDescription && !formData.companyName
                    }
                  >
